/**@flow*/
import {Store, GetState, PointDispatch, PointReducer, PointListen, PointAction, State, ThunkAction} from '../src/types'
...
declare module chai {
  declare class Assert {
    ...
    throws(function:Function, expected:Function|RegExp|string, value:string|RegExp, message:?string):void;
    doesNotThrows(function:Function, expected:Function|RegExp|string, value:string|RegExp, message:?string):void;
